...
CREATE DATABASE `librarydb` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `librarydb`;
...
(6,	'Ray Browns Bass Method',	'-',	'Ray Brown',	'Raymond Matthews Brown (October 13, 1926 – July 2, 2002) was an American jazz double bassist known for extensive work with Oscar Peterson and Ella Fitzgerald.',	4);
